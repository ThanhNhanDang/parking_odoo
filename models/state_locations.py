...
class state_locations(models.Model):
    ...
    product_id_name  = fields.Many2one('product.product', string="Biển số",default=211)
    # product_name  = fields.Many2one('stock.lot', string="Biển số",relation="product_id")
    
    lot_name = fields.Many2one('stock.lot', string="Mã định danh",default=63, relation="name")
